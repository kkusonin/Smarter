# This Makefile is for the Smarter extension to perl.
#
# It was generated automatically by MakeMaker version
# 6.92 (Revision: 69200) from the contents of
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Smarter]
#     EXE_FILES => [q[script/smarter_cgi.pl], q[script/smarter_create.pl], q[script/smarter_fastcgi.pl], q[script/smarter_server.pl], q[script/smarter_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[Smarter]
#     NO_META => q[1]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/smarter_cgi.pl \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  script/smarter_cgi.pl $(INST_MAN1DIR)/smarter_cgi.pl.$(MAN1EXT) \
	  script/smarter_create.pl $(INST_MAN1DIR)/smarter_create.pl.$(MAN1EXT) \
	  script/smarter_fastcgi.pl $(INST_MAN1DIR)/smarter_fastcgi.pl.$(MAN1EXT) \
...
EXE_FILES = script/smarter_cgi.pl script/smarter_create.pl script/smarter_fastcgi.pl script/smarter_server.pl script/smarter_test.pl

pure_all :: $(INST_SCRIPT)/smarter_test.pl $(INST_SCRIPT)/smarter_cgi.pl $(INST_SCRIPT)/smarter_fastcgi.pl $(INST_SCRIPT)/smarter_create.pl $(INST_SCRIPT)/smarter_server.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/smarter_test.pl $(INST_SCRIPT)/smarter_cgi.pl \
	  $(INST_SCRIPT)/smarter_fastcgi.pl $(INST_SCRIPT)/smarter_create.pl \
	  $(INST_SCRIPT)/smarter_server.pl 

$(INST_SCRIPT)/smarter_test.pl : script/smarter_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/smarter_test.pl
	$(CP) script/smarter_test.pl $(INST_SCRIPT)/smarter_test.pl
	$(FIXIN) $(INST_SCRIPT)/smarter_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/smarter_test.pl

$(INST_SCRIPT)/smarter_cgi.pl : script/smarter_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/smarter_cgi.pl
	$(CP) script/smarter_cgi.pl $(INST_SCRIPT)/smarter_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/smarter_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/smarter_cgi.pl

$(INST_SCRIPT)/smarter_fastcgi.pl : script/smarter_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/smarter_fastcgi.pl
	$(CP) script/smarter_fastcgi.pl $(INST_SCRIPT)/smarter_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/smarter_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/smarter_fastcgi.pl

$(INST_SCRIPT)/smarter_create.pl : script/smarter_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/smarter_create.pl
	$(CP) script/smarter_create.pl $(INST_SCRIPT)/smarter_create.pl
	$(FIXIN) $(INST_SCRIPT)/smarter_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/smarter_create.pl

$(INST_SCRIPT)/smarter_server.pl : script/smarter_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/smarter_server.pl
	$(CP) script/smarter_server.pl $(INST_SCRIPT)/smarter_server.pl
	$(FIXIN) $(INST_SCRIPT)/smarter_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/smarter_server.pl
